...
exports.getCourses = asyncHandler(async (req, res, next) => {
  if (req.params.bootcampId) {
    ...
    // Adding bootcamp object in courses "bootcamp" comes from courses schema property
    // this include all object
    // query = Course.find().populate("bootcamp");
    // Below allow us to include particular property from the bootcamp object
...
exports.addCourse = asyncHandler(async (req, res, next) => {
  req.body.bootcamp = req.params.bootcampId; // we are reference the courses model where bootcamp property is defined
